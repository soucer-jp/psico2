...
const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            ...
            if (entry.isIntersecting) {
                ...
                // ...e para de vigiar ele (pra não ficar piscando se subir e descer)
                observer.unobserve(entry.target);
            }
        });
    }, { threshold: 0.1 }); // Dispara quando 10% do item aparecer

    // Manda o observador vigiar tudo que tem a classe .animate-on-scroll
